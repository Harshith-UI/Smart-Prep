...
Do not include any additional text, headers, or formatting.`;
        ...
        const completion = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: `You are a ${specificSubject} teacher. Create EXACTLY ${numQuestions} unique questions about ${topic} that test understanding of scientific concepts and principles. Focus on practical applications and real-world examples.`
                },
                {
                    role: "user",
                    content: prompt
            ...
            temperature: 0.7,
            max_tokens: Math.max(4000, numQuestions * 300)
        });
